...
-- =====================================================
-- 2. VALIDATE TOTAL COURSE WEIGHT (<= 100%)
-- =====================================================
...
BEGIN
    ...
    IF total_weight > 100 THEN
        RAISE EXCEPTION 
        'Total evaluation weight for this course exceeds 100%% (Current total: %)',
        total_weight;
    END IF;
...
BEGIN
    ...
    IF EXISTS (
        ...
        RAISE EXCEPTION 
        'Student already enrolled in this course for this academic period';
    END IF;
...
-- =====================================================
-- 10. PERFORMANCE INDEXES (RECOMMENDED)
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_enrollment_period 
ON enrollment(academic_period_id);

CREATE INDEX IF NOT EXISTS idx_grade_enrollment 
ON grade(enrollment_id);

CREATE INDEX IF NOT EXISTS idx_evaluation_course 
ON evaluation_type(course_id);

CREATE INDEX IF NOT EXISTS idx_access_audit_user 
ON access_audit(user_id);

CREATE INDEX IF NOT EXISTS idx_access_audit_date 
